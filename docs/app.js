...
const NUMBER_LAYOUTS = {
  3: [[50, 53, 0], [50, 75, 0], [50, 97, 180]],
  4: [[40, 54, 0], [60, 54, 0], [40, 88, 180], [60, 88, 180]],
  5: [[40, 54, 0], [60, 54, 0], [50, 76, 0], [40, 88, 180], [60, 88, 180]],
  6: [[40, 50, 0], [60, 50, 0], [40, 74, 0], [60, 74, 0], [40, 98, 180], [60, 98, 180]],
  7: [[40, 49, 0], [60, 49, 0], [50, 64, 0], [40, 74, 0], [60, 74, 0], [40, 99, 180], [60, 99, 180]],
  8: [[40, 47, 0], [60, 47, 0], [40, 63, 0], [60, 63, 0], [40, 82, 180], [60, 82, 180], [40, 98, 180], [60, 98, 180]],
  9: [[40, 46, 0], [60, 46, 0], [40, 61, 0], [60, 61, 0], [50, 75, 0], [40, 85, 180], [60, 85, 180], [40, 100, 180], [60, 100, 180]],
  10: [[40, 45, 0], [60, 45, 0], [40, 59, 0], [60, 59, 0], [40, 74, 0], [60, 74, 0], [40, 88, 180], [60, 88, 180], [40, 102, 180], [60, 102, 180]],
};
...
function pipFieldSvg(card) {
  ...
  if (rank === 14) {
    return pipSvg(card, 50, 80, 26, 0);
  }
  if (rank === 17) {
    return `${pipSvg(card, 50, 49, 16, 0)}${pipSvg(card, 50, 103, 16, 180)}`;
  }
