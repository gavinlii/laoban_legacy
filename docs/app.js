...
const NUMBER_LAYOUTS = {
  3: [[50, 54], [50, 76], [50, 98]],
  4: [[39, 55], [61, 55], [39, 89], [61, 89]],
  5: [[39, 55], [61, 55], [50, 75], [39, 89], [61, 89]],
  6: [[39, 51], [61, 51], [39, 75], [61, 75], [39, 99], [61, 99]],
  7: [[39, 50], [61, 50], [50, 65], [39, 75], [61, 75], [39, 100], [61, 100]],
  8: [[39, 48], [61, 48], [39, 64], [61, 64], [39, 83], [61, 83], [39, 99], [61, 99]],
  9: [[39, 47], [61, 47], [39, 62], [61, 62], [50, 76], [39, 86], [61, 86], [39, 101], [61, 101]],
  10: [[39, 46], [61, 46], [39, 60], [61, 60], [39, 75], [61, 75], [39, 89], [61, 89], [39, 103], [61, 103]],
};
...
function pipFieldSvg(card) {
  ...
  if (rank === 14) {
    return pipSvg(card, 50, 82, 26, 0);
  }
  if (rank === 17) {
    return `${pipSvg(card, 50, 51, 16, 0)}${pipSvg(card, 50, 107, 16, 180)}`;
  }
